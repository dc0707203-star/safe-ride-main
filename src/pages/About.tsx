...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed text-white relative overflow-hidden font-sans selection:bg-[#CCFF00] selection:text-[#004225]" style={{ backgroundImage: `linear-gradient(135deg, rgba(5, 65, 35, 0.85) 0%, rgba(20, 70, 40, 0.9) 50%, rgba(5, 65, 35, 0.85) 100%), url('${campusBg}')` }}>
      ...
      {/* Navigation */}
      <nav className="relative z-50 flex justify-between items-center px-4 sm:px-6 lg:px-8 py-6 w-full">
      ...
      {/* Hero Section */}
      <section className="relative z-10 pt-12 pb-20 px-4 sm:px-6 w-full text-center reveal">
      ...
      {/* Mission & Vision */}
      <section className="py-20 w-full px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      {/* Team / Recognition */}
      <section className="py-24 w-full px-4 sm:px-6 lg:px-8 relative z-10 reveal">
