    ...
    try {
      let query = supabase
        ...
        .select(
          `
          *,
          students(full_name, student_id_number, contact_number),
          drivers(full_name)
        `
        );
      ...
      <div className="relative z-10 container mx-auto max-w-7xl px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="bg-blue-950/40 border border-cyan-500/30 overflow-hidden h-[600px] rounded-xl shadow-lg shadow-cyan-500/10">
              {alerts.length > 0 ? (
                <div className="w-full h-full rounded-lg overflow-hidden">
                  <iframe
                    ...
                    height="100%"
                    frameBorder="0"
                    src={`https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d4000!2d${alerts[0]?.location_lng}!3d${alerts[0]?.location_lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sph!4v1234567890`}
                    style={{ border: 0 }}
                    allowFullScreen
                    loading="lazy"
