  ...
  return (
    <>
      ...
      <div className="min-h-screen relative">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Dialog open={showDriverAnnouncementDialog} onOpenChange={setShowDriverAnnouncementDialog}>
                  ...
                  <DialogContent className="sm:max-w-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-white/20 text-white shadow-2xl rounded-2xl">
        ...
        {/* Main Content */}
        <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-8 max-w-7xl">
