            ...
            {sortedGroupKeys.map((groupKey) => {
              ...
              return (
                <div key={groupKey} className="bg-card rounded-2xl border border-border overflow-hidden shadow-sm">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="p-2.5 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-700 shadow-md">
                        ...
                        {group.students.map((student) => (
                          <Card key={student.id} className={`group hover:shadow-lg transition-all duration-300 border-border/50 overflow-hidden ${!student.is_approved ? 'ring-2 ring-amber-400/50' : ''}`}>
                            <CardContent className="p-0">
                              ...
                              <div className="bg-gradient-to-br from-emerald-500/10 to-emerald-500/10 p-4 border-b border-border/50">
                                <div className="flex items-start gap-4">
                                  {student.photo_url ? (
                                    ...
                                    <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-700 flex items-center justify-center border-2 border-white shadow-md">
                              ...
                              <div className="p-4 space-y-2.5">
                                ...
                                <Button
                                  ...
                                  className="w-full mt-2 gap-2 rounded-lg border-emerald-200 text-emerald-600 hover:bg-emerald-50 hover:text-emerald-700"
                                >
