    ...
    >
      <div className="relative z-10 w-full">
        ...
        <div className="relative mb-8 landscape:mb-4">
          <div className="bg-white rounded-3xl overflow-hidden shadow-2xl md:grid md:grid-cols-5 md:min-h-[560px] md:max-h-[720px] md:h-[calc(100vh-200px)]">
            {/* Desktop left panel */}
            <div className="hidden md:flex md:col-span-2 flex-col justify-between p-8 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800">
              <div>
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 h-8 w-8 rounded-xl bg-white/10 flex items-center justify-center border border-white/20 transition-all hover:bg-white/15 hover:border-white/30">
            ...
            {/* Right panel */}
            <div className="md:col-span-3 md:overflow-y-auto md:flex md:flex-col">
