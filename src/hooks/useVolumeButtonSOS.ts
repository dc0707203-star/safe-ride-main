...
export function useVolumeButtonSOS({ onTrigger, enabled = true }: UseVolumeButtonSOSProps) {
  ...
  // Note: Global window.volumeButtonSOSTriggered is now exposed at the Student component level
  // This hook only handles local volume button detection via keyboard events
